        ...
        <ul className="inline-flex -space-x-px">
          ...
          <li>
            <a
              href="#"
              aria-current="page"
              className=" bg-white border border-gray-300 text-gray-500 hover:bg-gray-100 hover:text-gray-700 leading-tight py-2 px-3 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:bg-gray-700 "
            >
              1
            </a>
          </li>
          ...
          <li>
            <a
              href="#"
              className="bg-blue-50 border border-gray-300 text-blue-600 hover:bg-blue-100 hover:text-blue-700  py-2 px-3 dark:border-gray-700 dark:text-gray-400"
            >
              3
            </a>
          </li>
